...
CREATE TABLE IF NOT EXISTS `mydb`.`T_TOPIC` (
  ...
  INDEX `fk_T_TOPIC_T_USER1_idx` (`FK_USER_ID` ASC),
  CONSTRAINT `fk_T_TOPIC_T_USER1`
    FOREIGN KEY (`FK_USER_ID`)
    REFERENCES `mydb`.`T_USER` (`USER_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`T_COMMENT` (
  ...
  INDEX `fk_T_COMMENT_T_TOPIC1_idx` (`FK_TOPIC_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`T_RATING_TOPIC` (
  ...
  INDEX `fk_T_RATING_TOPIC_T_TOPIC1_idx` (`FK_TOPIC_ID` ASC),
